...
const Login = ({ setUser }) => {
  ...
  useEffect(() => {
    let currentIndex = 0;    const typingInterval = setInterval(() => {
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#081320]">
      <div className="flex w-[1000px] shadow-2xl h-[500px]">
            ...
            <div className="mb-6">
              <div className="relative">
                ...
                >
                  ...
                  <div className="text-red-500 text-xs mt-1 ml-1">Check your password</div>
                )}
              </div>
        ...
        <div className="w-3/5 bg-[#0B1829] flex flex-col items-center justify-center text-white rounded-r-md">
          <div className="text-center">            <h1 className="text-4xl font-bold whitespace-pre-line leading-tight">{typingText}</h1>
            <p className="text-sm mt-12">© Nagad | {new Date().getFullYear()}</p>
          </div>
        </div>
      </div>
    </div>
